...
from weather_agent.config import MAX_TURNS
...
def run_agent_turns(messages:list, max_turns:int = MAX_TURNS) -> str:
    ...
    for _ in range(max_turns):
        ...
        for call in message.tool_calls:
            ...
            if name not in TOOL_FUNCTIONS:
                ...
                tool_result = TOOL_FUNCTIONS[name](**arguments) # make he actual tool call
    ...
    # this will be triggered if agent loop doesnt end in max turns
